...
inherit flag-o-matic autotools gnome2 multilib virtualx
...
SRC_URI="${SRC_URI}
	https://launchpad.net/~gnome3-team/+archive/gnome3-staging/+files/gtk%2B3.0_3.12.1-0ubuntu1%7Etrusty1.debian.tar.gz"
