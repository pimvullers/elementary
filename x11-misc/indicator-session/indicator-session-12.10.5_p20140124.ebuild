...
SRC_URI="https://launchpad.net/ubuntu/+archive/primary/+files/indicator-session_12.10.5%2B14.04.20140124.orig.tar.gz"
...
S="${WORKDIR}/indicator-session-12.10.5+14.04.20140124"
DOCS=( "${S}/COPYING" "${S}/NEWS" "${S}/README" )
