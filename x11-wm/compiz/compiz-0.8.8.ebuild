...
# $Header: /var/cvsroot/gentoo-x86/x11-wm/compiz/compiz-0.8.8.ebuild,v 1.3 2011/11/11 22:54:51 ssuominen Exp $
...
src_prepare() {
	...
	#epatch "${FILESDIR}"/${PN}-0.8.6-gdk-display-deprecated.patch
